...
dend<- dendextend::dendlist(
  "Resnik"=methods::slot(Resnik_clusters_wardD2,"dendrograms")$GO,
  "Lin"=methods::slot(Lin_clusters_wardD2,"dendrograms")$GO,
  "Rel"=methods::slot(Rel_clusters_wardD2,"dendrograms")$GO,
  "Jiang"=methods::slot(Jiang_clusters_wardD2,"dendrograms")$GO,
  "wang"=methods::slot(Wang_clusters_wardD2,"dendrograms")$GO
)
...
dl<-dendextend::dendlist(
  methods::slot(Resnik_clusters_wardD2,"dendrograms")$GO,
  methods::slot(Wang_clusters_wardD2,"dendrograms")$GO
)
