...
<img src=`r base::system.file("extdata/","workflow.png",package="ViSEAGO")` alt="workflow" style="width:100%;height:100%;"/>
...
You can also optionally create directories to store gene lists in the input folder, and export the results in the output folder.
