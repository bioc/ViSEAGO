...
```{r setup,include=FALSEALSE,cache=FALSE}
###################
# koad ViSEAGO
library(ViSEAGO)
...
knitr::opts_chunk$set(
  eval=FALSE,fig.path='./data/output/',echo=TRUERUE,fig.pos = 'H',
...
```{r grViz,echo=FALSE,eval=TRUE,fig.height=5.5} 
###################
...
base::dir.create("./data/input",recursive=TRUE,showWarnings=FALSE)
base::dir.create("./data/output",showWarnings=FALSE)
base::dir.create("./data/cache",showWarnings=FALSE)
```

# Genes of interest

```{r grViz_genes,echo=FALSE,eval=TRUE,fig.height=4} 
###################
...
background<-base::scan("./data/input/background.txt",quiet=TRUE,what="")

###################
# load gene selection
selection<-base::scan("./data/input/selection.txt",quiet=TRUE,what="")
```

# GO annotation of genes

```{r grViz_annotations,echo=FALSE,eval=TRUE,fig.height=4} 
###################
...
```{r grViz_enrichment,echo=FALSE,eval=TRUE,fig.height=4} 
###################
...
```{r grViz_SS,echo=FALSE,eval=TRUE,fig.height=4} 
###################
...
```{r grViz_vis,echo=FALSE,eval=TRUE,fig.height=4} 
###################
