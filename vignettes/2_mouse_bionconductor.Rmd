...
knitr::opts_chunk$set(
  fig.path='./data/output/',echo=TRUE,fig.pos = 'H',
...
```{r Genomic-ressources_target-species_GO,eval=FALSE}
###################
...
<u>NB:</u> For this vignette, this illustration is not interactive. You can display it interactively by running `ViSEAGO::MDSplot(Wang_clusters_wardD2,show_clusters=TRUE)`.
